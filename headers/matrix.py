...
# #M
G.add_edge(319, 767, w=6)
G.add_edge(767, 319, w=6)
    # M001S = 319,
G.add_edge(320, 752, w=6)
...
G.add_edge(503, 322, w=6)
    # M004S = 322,
G.add_edge(323, 500, w=6)
G.add_edge(500, 323, w=6)
    # M005S = 323,
G.add_edge(324, 764, w=6)
G.add_edge(764, 324, w=6)
    # M006S = 324,
# #N
G.add_edge(325, 785, w=6)
G.add_edge(785, 325, w=6)
    # N001S = 325,
G.add_edge(326, 769, w=6)
G.add_edge(769, 326, w=6)
    # N002S = 326,
G.add_edge(327, 774, w=6)
G.add_edge(774, 327, w=6)
    # N003S = 327,
G.add_edge(328, 528, w=6)
G.add_edge(528, 328, w=6)
    # N004S = 328,
G.add_edge(329, 523, w=6)
G.add_edge(523, 329, w=6)
    # N005S = 329,
G.add_edge(330, 781, w=6)
G.add_edge(781, 330, w=6)
    # N006S = 330,
# #O
G.add_edge(331, 803, w=6)
G.add_edge(803, 331, w=6)
    # O001S = 331,
G.add_edge(332, 787, w=6)
G.add_edge(787, 332, w=6)
    # O002S = 332,
G.add_edge(333, 791, w=6)
G.add_edge(791, 333, w=6)
    # O003S = 333,
G.add_edge(334, 551, w=6)
G.add_edge(551, 334, w=6)
    # O004S = 334,
G.add_edge(335, 547, w=6)
G.add_edge(547, 335, w=6)
    # O005S = 335,
G.add_edge(336, 800, w=6)
