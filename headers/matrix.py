...
# #G
# G.add_edge(283, 368, w=6)
# G.add_edge(368, 283, w=6)
#     # G001S = 283,
# G.add_edge(284, 371, w=6)
# G.add_edge(371, 284, w=6)
#     # G002S = 284,
...
#     # G006S = 288,
# #H
# G.add_edge(289, 392, w=6)
# G.add_edge(392, 289, w=6)
#     # H001S = 289,
# G.add_edge(290, 395, w=6)
# G.add_edge(395, 290, w=6)
#     # H002S = 290,
...
#     # H006S = 294,
# #I
# G.add_edge(295, 416, w=6)
# G.add_edge(416, 295, w=6)
#     # I001S = 295,
# G.add_edge(296, 419, w=6)
# G.add_edge(419, 296, w=6)
#     # I002S = 296,
...
#     # I006S = 300,
# #J
# G.add_edge(301, 440, w=6)
# G.add_edge(440, 301, w=6)
#     # J001S = 301,
# G.add_edge(302, 443, w=6)
# G.add_edge(443, 302, w=6)
#     # J002S = 302,
...
#     # J006S = 306,
# #K
# G.add_edge(307, 464, w=6)
# G.add_edge(464, 307, w=6)    
#     # K001S = 307,
# G.add_edge(308, 467, w=6)
# G.add_edge(467, 308, w=6)    
#     # K002S = 308,
...
#     # K006S = 312,
# #L
# G.add_edge(313, 488, w=6)
# G.add_edge(488, 313, w=6)  
#     # L001S = 313,
# G.add_edge(314, 491, w=6)
# G.add_edge(491, 314, w=6)  
#     # L002S = 314,
